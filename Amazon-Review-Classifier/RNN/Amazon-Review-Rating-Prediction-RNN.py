...
this architecture will employ a simply RNN, which we will use as a baseline in the analysis
...
2) Measure of Success:
	-recommended to use: Mean squared error
...
train_samples = []
#
fp = open(os.path.abspath("../Good_Samples.csv"), "r")
fp.readline()
